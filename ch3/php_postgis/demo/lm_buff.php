...
$conn = new PDO('pgsql:host=localhost;dbname=phitsanulok','postgres','postgres');


# Build SQL SELECT statement and return the geometry as a GeoJSON element
$sql = "SELECT p.name, public.ST_AsGeoJSON(p.geom) AS geojson FROM plk_points p, plk_ways_4326 w where st_contains (st_buffer(w.geom ,0.001),p.geom);";
