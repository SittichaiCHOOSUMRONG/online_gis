...
$conn = new PDO('pgsql:host=localhost;dbname=lddgis','postgres','Bomp156675');

# Build SQL SELECT statement and return the geometry as a GeoJSON element
$sql = "SELECT *, public.ST_AsGeoJSON(public.ST_Transform((geom),4326),6) AS geojson FROM admin_province where provinceid='65'";
